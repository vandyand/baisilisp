...
* Immutable data structures, backed by a native 32-way vector tree plus `Immutables <https://github.com/MagicStack/immutables>`_ and `Pyrsistent <https://github.com/tobgu/pyrsistent>`_ where appropriate
